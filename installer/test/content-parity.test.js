...
import { cursorRules, SERVER_URL } from '../src/content.js';
import { merge } from '../src/mcp-json.js';

// The canonical copies live one level up in this repo (cursor/). These
// tests turn doctrine drift between the installer and those files into a
// CI failure instead of a manual sync chore.
